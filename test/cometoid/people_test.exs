defmodule Cometoid.PeopleTest do
  use Cometoid.DataCase

  alias Cometoid.People

  describe "persons" do
    alias Cometoid.People.Person

    @valid_attrs %{birthdate: ~D[2010-04-17], description: "some description", name: "some name"}
    @update_attrs %{birthdate: ~D[2011-05-18], description: "some updated description", name: "some updated name"}
    ...
    test "create_person/1 with valid data creates a person" do
      ...
      assert person.birthdate == ~D[2010-04-17]
    ...
    test "update_person/2 with valid data updates the person" do
      ...
      assert person.birthdate == ~D[2011-05-18]
